			...
			<div class="<?php echo $content_right; ?> product_page-right">
				...
				<div id="product">
					...
					<ul class="product-buttons">
						...
						<li><a href="http://aeroportasonline.com.br/" target="_blank"><button type="button" class="btn btn-icon"><i class="fa-shopping-cart"></i> <span class="hidden-xs hidden-sm">Loja Online</span></button></a></li>
					</ul>					
