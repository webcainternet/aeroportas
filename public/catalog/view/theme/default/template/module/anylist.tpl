		...
		<?php foreach ($products as $product) { ?>
			  <div class="AnyListDiv">
			    <div class="product-thumb transition">
                    ...
                    <div class="image imagenova"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
                    <?php } ?>
                    <div>
                        <div class="caption">
                            <h4 style="height: 40px; overflow: hidden;" class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></h4>
